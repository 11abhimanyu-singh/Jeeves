...
enum OpenAIJudgeService {
    ...
    private static func userPrompt(plan: GeneratedPlan, scenario: String) -> String {
        ...
        s += "- Work ends at the 20:30 boundary. The evening 20:30–23:00 is wind-down / personal time and Sleep is a FIXED anchor at 23:00 — their presence AFTER 20:30 is correct; never penalize it or count it as overrunning the day.\n\n"
        s += "THE PLAN TO SCORE:\n"
