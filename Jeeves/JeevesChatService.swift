        ...
        [
            ...
            "input_schema": [
                ...
                "properties": [
                    ...
                    "recurrence": ["type": "string", "enum": ["once", "daily", "weekdays", "weekly", "everyNDays"], "description": "Default once. Use everyNDays with interval_days for rhythms a week cannot express, e.g. every 3 days or once a fortnight."],
                    "interval_days": ["type": "integer", "description": "Days between fires. Only read when recurrence is everyNDays."],
                ],
                "required": ["title", "time"],
            ],
        ],
